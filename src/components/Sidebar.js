...
export default function Sidebar({ activeSection }) {
  ...
  return (
    <div className="w-64 bg-[#081440] flex flex-col justify-between py-6 px-4 transition-all duration-300 ease-in-out transform translate-x-0">
      {/* Top Section */}
      <div className="transition-all duration-300 animate-fade-in-left">
        ...
        <nav className="space-y-1">
          ...
          <button
            ...
            className="w-full flex items-center space-x-3 px-4 py-3 rounded-lg text-sm transition-all duration-200 text-gray-300 hover:bg-white/10 transform hover:translate-x-1"
          >
            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 opacity-70" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <div className="px-3 pt-6 border-t border-white/10 transition-all duration-300 animate-fade-in-left delay-100">
        <div className="flex items-center space-x-3">
          ...
          <div>
            ...
            <p className="text-gray-400 text-xs transition-all duration-300 truncate max-w-[120px]">
